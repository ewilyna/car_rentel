...
SECRET_KEY = 'django-insecure-69*xb=jiha!hr&fwn#qiri=h&8@svewx=g_dgo2a&y6!l2@i=r'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'toniha6t_databa2',  # Имя вашей базы данных
        'USER': 'toniha6t_databa2',  # Пользователь базы данных
